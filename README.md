<h1 align="center">Galaxio Entellect Challenge 🚀 <br> Bot Implementation using Greedy Algorithm</h1>
...
# 📝 Project Description 
A bot made for the Galaxio game as part of The Entellect Challenge 2021. The bot is implemented in Java and follow the greedy algorithm paradigm. There are in total 8 states that the bot can be in:
...
*There are in total 5 things you should run: The engine, this bot, and 3 other bots. If you want to visualize the gameplay, then you have to run 1 more* 
...
### Run the Bots
In the [latest release](https://github.com/cadevue/galaxio-entellect-challenge/releases/tag/v1.0.0), there are 2 bots you can use for the game: SolarSailers (The Old Bot) and TheCadevue (New Bot).

1. Download the zipped bot in the [latest release page](https://github.com/cadevue/galaxio-entellect-challenge/releases/tag/v1.0.0)!
2. Extract the zip!
...
The game will first be simulated in the terminal, and will generate logs that can be visualized. To visualize the game, you should run the visualizer. More about it in the [visualizer documentation](https://github.com/cadevue/galaxio-entellect-challenge-engine/blob/master/visualiser/README.md).
...
Oh, the original bot (SolarSailers) was also being competed with other bots from the course class, and it actually got the 2️nd place! I got this mug as a prize:D
<br>
